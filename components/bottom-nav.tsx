...
export default function BottomNav() {
  ...
  return (
    ...
    >
      ...
      <NavButton href="/terms" label="Terms" icon={<svg viewBox="0 0 24 24"><path d="M6 3h11a2 2 0 0 1 2 2v14l-4-2-4 2-4-2-4 2V5a2 2 0 0 1 2-2h1Z"/></svg>} />
      ...
      <NavButton href="/privacy" label="Privacy" icon={<svg viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z"/></svg>} />
    </nav>
  );
}