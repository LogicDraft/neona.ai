        ...
        <div style={{ display: "flex", height: "100%", position: "relative", zIndex: 1 }}>
          ...
          {!isMobile && (
            <Sidebar
              ...
              onNewChat={() => setMessages([{
                id: Date.now(), role: "ai",
                text: "New conversation started! What would you like to schedule? ✦",
                event: null, ts: "Now",
              }])}
              googleConnected={googleConnected}
              onGoogleConnect={() => setGoogleConnected(g => !g)}
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
            ...
            <div style={{
              ...
              {isMobile && (
                <GoogleConnectButton connected={googleConnected} onConnect={() => setGoogleConnected(g => !g)} theme={theme} />
              )}
